...
async function RecruitPage() {
  ...
  return (
    <main className="flex flex-col items-center">
      <Link
        href={
          "https://linktr.ee/kusitms.official?fbclid=PAQ0xDSwLkjtxleHRuA2FlbQIxMQABp1reIDGc9rGLYwcFWw6nIUwveL3LZsO_wkCAUv1bCVqJV1bpZ3OiOuxnG9hf_aem_8WqYpMfygHNOS6ebzkuCrw"
        }
        className="flex gap-x-1 items-center font-semibold text-[20px] px-8 py-4 rounded-full bg-[#0055FF] hover:scale-105 transition cursor-pointer mt-[24px] desktop:mb-[100px]"
      >
        함께하러 가기
        <Image
