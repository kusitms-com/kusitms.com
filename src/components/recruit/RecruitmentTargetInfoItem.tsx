    ...
    <section className="flex flex-col desktop:flex-row w-full gap-x-[20px] justify-center items-center gap-y-[40px]">
      {recruitItems.map((item, index) => (
        <section key={index} className="relative desktop:pt-[50px] pt-[30px]">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 flex justify-center items-center bg-white desktop:rounded-[32px] rounded-[20px] desktop:w-[100px] desktop:h-[100px] w-[60px] h-[60px]">
          ...
          <div
            className={
              "rounded-[32px] bg-[#2F3038] desktop:w-[380px] w-[334px] desktop:pb-[63px] pb-[46px] desktop:pt-[90px] pt-[67px]"
            }
          >
