...
export default function MeetingInfoItem() {
    return (
        <section
            className={"rounded-[32px] bg-[#2F3038] desktop:w-[1180px] w-[334px] desktop:py-[55px] py-[40px]"}
        >
            <div
                className={
            ...
            >
                <div className="flex flex-col items-center justify-center gap-y-[20px]">
                    <div
                        className="flex gap-x-3 items-center font-extrabold desktop:text-[24px] text-[20px] tracking-[0px] text-center leading-relaxed">
