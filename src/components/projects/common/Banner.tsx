...
export default function Banner({
  ...
  return (
    <>
      {/* 데스크톱 */}
      <section className="w-full desktop:block hidden relative bg-[linear-gradient(120deg,_#EAF9FF_0%,_#99DEFF_90%,_#4688FE_120%)]">
      ...
      {/* 모바일 */}
      <section className="w-full relative desktop:hidden bg-[linear-gradient(120deg,_#EAF9FF_0%,_#99DEFF_90%,_#4688FE_120%)]">
        <div className="mx-auto relative">
          <div className="w-full mx-auto relative h-[180px] overflow-hidden">
            ...
            <div className="absolute inset-0 flex pt-[32px] gap-[3.6px] pl-[32px] pointer-events-none z-10">
              <div className="w-full">
                <p className="text-body-1 text-dark-blue-600">{title}</p>
