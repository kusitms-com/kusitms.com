    ...
    return (
        <div className={"flex flex-col justify-center items-center py-[200px]"}>
            <section>
                ...
                <p className={"text-[20px] mt-[48px] text-center"}>KUSITMS에서는 학회원이 새로운 경험을 통해 성장할 수 있도록 <br/>
                    다양한 프로그램을 진행해요.</p>

                {/* 카드 */}
                <section className={"relative mt-[100px] grid grid-cols-2 w-[930px] h-[1330px]"}>
