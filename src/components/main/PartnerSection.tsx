...
export default function PartnerSection() {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className={
        "hidden tablet:flex max-w-[1024px] mx-auto pt-4 px-4 tablet:px-10 pb-[100px] tablet:pb-[120px] flex-col justify-center items-center"
      }
    >
      <h1 className="text-[23px] tablet:text-title-5 text-gray-900 text-center font-semibold">
        KUSITMS 파트너사
      </h1>
