...
const PartnerSection = () => {
    ...
    return (
        <motion.div
            ...
            viewport={{once: true}}
            className={"pt-[200px] pb-[120px] flex flex-col justify-center items-center"}
        >
            ...
            <p className={"mt-[48px] text-[20px]"}>KUSITMS과 함께하는 파트너사를 소개해요.</p>
...
const PartnerCard = ({name, description, image, url} : {
    name: string;
    description: string;
    image: string;
    url: string;
